...
const features = [
  ...
  },
  {
    ...
    description: "Plan and manage sprints effectively, ensuring your team stay focused on delvering value.",
    icon: Calendar,
  },
  {
    title: "Comprehensive Reporting",
    description: "Gain insights your team's performance with detailed, customizable reports and analytics.",
    icon: BarChart,
  },
];

export default function Home() {
  // Function to handle smooth scrolling to the features section
